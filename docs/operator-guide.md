...
2. Register the client's intake: business type, the specific
   MHLW-regulated activity involved, prior filing/compliance
   history in Japan if any.
3. Run the advisor in read-only mode against Ministry of Health, Labour and Welfare's
   (厚生労働省) published guidance.
...
5. Enable gated filing/compliance-draft assistance once the
   Labor-Standards Compliance Governor contract is trusted; actual submission always
   requires human sign-off.

## Minimum Production Controls

- client-owned data store for compliance documents
- clear provenance (official MHLW source citation) for every
...
automated actions cannot bypass the Labor-Standards Compliance Governor, and a working
